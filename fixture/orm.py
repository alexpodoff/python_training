...
class ORMFixture:
        ...
        class ORMGroup(db.Entity):
            ...
            contacts = Set(
                lambda: ORMFixture.ORMContact, table="address_in_groups", column='id', reverse='groups', lazy=True)
        ...
        def convert_contacts_to_model(self, contacts):
            def convert(contact):
                return Contact(id=str(contact.id), name=contact.firstname, lastname=contact.lastname,
                               address=contact.address, email=contact.email, email2=contact.email2,
                               email3=contact.email3, home=contact.home, mobile=contact.mobile,
                               work=contact.work, phone2=contact.phone2)
